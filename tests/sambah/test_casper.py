...
def test_casper(failed_tests, harmony_client, service_collection, earthaccess_login):
    """Run a request against sambah+casper and make sure it is successful.
